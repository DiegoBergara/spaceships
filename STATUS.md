...
- ✅ Tras el crash y en el menú, el campo de asteroides sigue generando nuevas oleadas detrás del mismo panel central de game over. El menú oculta la nave y protege la lectura con una tarjeta oscura translúcida. Los asteroides reciben la progresión global ×1 → ×2.8 y su aceleración individual de aproximación. Planetas helados y una estrella/Sol inmensos pasan cerca de la nave aproximadamente cada 16–32 s.
