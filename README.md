...
| Drag with touch or primary mouse button | Fly and auto-fire while dragging |
| Tap/click the game screen | Start or restart |
...
- Mobile and mouse controls: drag to fly and auto-fire while moving. Keyboard controls remain available.
